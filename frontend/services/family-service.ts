  ...
  static async getFamilyMemberById(id: string): Promise<FamilyMember | null> {
    ...
    try {
      ...
      return {
        ...
        gender: data.gender || "Не указано",
        registrationAddress: data.registrationAddress || "Не указано",
        idCardNumber: data.idCardNumber || "Не указано",
        idCardIssueDate: data.idCardIssueDate || "Не указано",
        idCardExpiryDate: data.idCardExpiryDate || "Не указано",
        idCardNotes: data.idCardNotes || "Не указано",
        school: data.school || "Не указано",
        grade: data.grade || "Не указано",
        institution: data.institution || "Не указано",
        course: data.course || "Не указано",
        funding: data.funding || "Не указано",
        meals: data.meals || "Не указано",
        preschool: data.preschool || "Не указано",
        freeTextbooks: data.freeTextbooks || false,
        freeMeals: data.freeMeals || false,
        needsSupport: data.needsSupport || false,
        needsKindergarten: data.needsKindergarten || false,
        specialNeeds: data.specialNeeds || false,
        hasDisability: data.hasDisability || false,
        chronicIllness: data.chronicIllness || false,
        needsMedicalCare: data.needsMedicalCare || false,
        medicalNotes: data.medicalNotes || "Не указано",
        notes: data.notes || "Не указано",
        createdAt: data.createdAt || "Не указано",
        updatedAt: data.updatedAt || "Не указано",
        birthDate: data.birthDate || "Не указано",
      };
    } catch (error) {
